...
plt.tight_layout()
plt.savefig(os.path.join(output_dir, "fig_apoptosis_6vars.png"),
...
plt.tight_layout()
plt.savefig(os.path.join(output_dir, "fig_apoptosis_IC_comparison.png"),
            dpi=150, bbox_inches="tight")
...
plt.tight_layout()
plt.savefig(os.path.join(output_dir, "fig_apoptosis_a12_variation.png"),
            dpi=150, bbox_inches="tight")
